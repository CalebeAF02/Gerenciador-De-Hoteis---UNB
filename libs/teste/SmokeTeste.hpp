...
namespace Teste {
    ...
    template<typename T>
    void SmokeTeste::testarDominio(int esperando_resultado, const T &valor_teste, const string &dominio,
                                   function<void()> funcao_validacao) {
    ...
    template<typename T>
    void SmokeTeste::testarEntidade(int esperando_resultado, const T &valor_teste, const string &entidade,
                                    function<void()> funcao_validacao) {
        // Converte o tipo T (int, float, etc.) para string e chama a versão string.
        this->testarEntidade(
            esperando_resultado,
